                    ...
                    ->prototype('array')
                        ->children()
                            ...
                            ->arrayNode('upload')
                                ...
                                ->end()
                            ->end()
                            ->scalarNode('depth_subdirectories')->defaultValue("all")->end()
                            ->booleanNode('disable_rename')->defaultValue(false)->end()
                            ->booleanNode('disable_treeview')->defaultValue(false)->end()
                            ->booleanNode('disable_delete')->defaultValue(false)->end()
                            ->booleanNode('disable_download')->defaultValue(false)->end()
                        ->end()
                    ->end()
                ->end()
            ->end();
